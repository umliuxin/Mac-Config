...
export ZSH="/Users/xinliu-mbp/.oh-my-zsh"
...
plugins=(git z zsh-autosuggestions docker npm command-not-found)
...
alias localip='ipconfig getifaddr en0'      # localip:      Public facing IP Address
alias myip='ipconfig getifaddr en0'         # myip:         Public facing IP Address
killport () { kill -9 $(lsof -i tcp:"$1" -t)} # Kill port process